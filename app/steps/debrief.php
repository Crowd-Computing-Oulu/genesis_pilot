<?php
$page_title = 'GENESIS Study — Thank You';
...
<div class="study-card">
    ...
    <p>You have completed the GENESIS study. Your contribution helps us understand how people describe their self-care practices and will inform the design of a citizen-science platform for self-care research.</p>

    <h5 class="mt-4">About This Study</h5>
    <p>The GENESIS project is developing a formal language for everyday self-care — "behavioural genes" that capture what you do, how much, and in what way. Your description is now part of the first seed corpus for this genome of self-care practices.</p>
